...
requirements = python3,kivy==2.0.0rc1,paho-mqtt,python-socketio,android, openssl, pyopenssl, httplib2,requests,certifi,urllib3,chardet,idna,plyer,kivy_garden.mapview, pytz
